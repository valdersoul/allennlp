...
@TokenEmbedder.register("sentence_encoding")
class TokenSentencesEncoder(TokenEmbedder):
    """
    ...
    def __init__(self, embedding: Embedding) -> None:
        super(TokenSentencesEncoder, self).__init__()
    ...
    def forward(self, token_characters: torch.Tensor) -> torch.Tensor:  # pylint: disable=arguments-differ
        ...
        return self._embedding(token_characters)
